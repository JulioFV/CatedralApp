...
import { Archive, Calendar, MapPin, Package, Users } from 'lucide-react-native';
                ...
                <View style={styles.summaryCard}>
                    ...
                    <View style={styles.statsRow}>
                        <View style={styles.statItem}>
                            ...
                            <Text style={styles.statValue}>248</Text>{/*+ESTO SE DEBE DE MODIFICAR CUANDO SE CONECTE A LA BD*/}
                        </View>
                        <View style={styles.statItem}>
                            <Text style={styles.statLabel}>Préstamos</Text>
                            <Text style={styles.statValue}>32</Text>{/*+ESTO SE DEBE DE MODIFICAR CUANDO SE CONECTE A LA BD*/}
                        </View>
                        <View style={styles.statItem}>
                            <Text style={styles.statLabel}>Ubicaciones</Text>
                            <Text style={styles.statValue}>15</Text>{/*+ESTO SE DEBE DE MODIFICAR CUANDO SE CONECTE A LA BD*/}
                        </View>
                    </View>
                </View>
            </View>
